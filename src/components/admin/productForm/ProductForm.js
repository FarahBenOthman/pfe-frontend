      ...
      <div>
        <BsTrash size={15} className="thumbnailIcon" onClick={() => removeImage(image)} />
          ...
          <hr />
            ...
            <input type="text" placeholder="Product name" name="name" value={product?.name} onChange={handleInputChange} required />


            <label>Product Category:</label>
            <select name="category" value={product?.category} className="form-control" onChange={handleInputChange}>
            {isEditing ? (
